...
namespace config{
    ...
    void setValues(){
        ...
        iC.database="ruuvi_db";
        // Influx database username for writing
        iC.username="ruuvi_db";
        // The username's password
        iC.password="ruuvi_db";
    ...
    std::string mqttServerIP="homeassistant.local";
    // and port number
    ...
    std::string mqttServerUsername="mosqito";
    // and password
    std::string mqttServerPassword="awtrix";
    ...
    const std::string timeZone="UTC+6";
    ...
    const int deepSleepWakeUpAtSecond=30;
    // Example value -2 causes wake-up at 12:00:58, 12:01:58, 12:02:58
    const int deepSleepWakeUpOffset=15;
